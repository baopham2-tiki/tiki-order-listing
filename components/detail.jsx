...
const detail = () => {
  ...
  const detailsSubtotal = details?.subtotal?.toLocaleString()
  console.log(18, detailsSubtotal)
          ...
          <table>
            ...
            <tfoot>
              <tr>
                ...
                <td>{details.subtotal?.toLocaleString()} ₫</td>
              </tr>
              <tr>
                <td colspan="4">
              ...
              <tr>
                ...
                <td>
                  <span className="sum">{details.grand_total?.toLocaleString()} ₫</span>
                </td>
              </tr>
              <tr>
                <td colspan="5">
