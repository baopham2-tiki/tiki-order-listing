            ...
            {orders.map((order, index) => {
                ...
                return (
                    <StyledOrder>
                        ...
                        <OrderInfor>
                            <OderDetail>
                                <DetailImg><img src={orderItem.thumbnail_url}></img>
                                    <span className="quantity">x{orderItem.qty}</span></DetailImg>
                                <ProductInfor>
                                    <p>{order.description}</p>
                                    <div className='store'>{orderItem.current_seller.store.name}</div>
                                </ProductInfor>
                            </OderDetail>
                            <PriceDetail><span>{(orderItem.price).toLocaleString()} ₫</span></PriceDetail>
                        </OrderInfor>
                        <OrderFooter>
                            <TotalMoney>
