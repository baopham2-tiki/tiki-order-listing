...
const detail = () => {
  ...
  console.log(details)
  const detailSreet = details.shipping_address.street.toLocaleString()
  console.log(detailSreet)
          ...
          <DetailGroupSection>
            <Section>
              ...
              <div className="content">
                ...
                <p className="address">
                  <span>Địa chỉ: </span>
                  {details.code}, CMT8, Phường 12, Quận 10, Hồ Chí Minh, Việt Nam
                </p>
                <p className="phone">
          ...
          <DetailGroupSection>
            <Section>
              ...
              <div className="content">
                <p className="name">Tiki Trading</p>
                <p className="address">
                  <span>Địa chỉ: </span>285 Toà Nhà Viettel, CMT8, Phường 12, Quận 10, Hồ Chí Minh,
                  Việt Nam
                </p>
                <p className="phone">
                  <span>Điện thoại: </span>0909811211
