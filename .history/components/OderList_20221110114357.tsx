...
const OderList = () => {
  ...
  const { data, error, loading } = useSelector((state: NewType) => state.orders)
    ...
    <OrderList>
      <StyledOrder>
        ...
        <OrderInfor>
          <OderDetail>
            <DetailImg>
              <img src="https://uat.tikicdn.com/cache/200x200/ts/product/ed/77/34/5ac094603998b37254d2c149d5d4f658.jpeg"></img>
